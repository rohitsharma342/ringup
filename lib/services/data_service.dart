...
class DataService extends ChangeNotifier {
  ...
  void startContest(String contestId) {
    _currentContestId = contestId;
    _currentQuestionIndex = 0;
    _currentScore = 0;
    _loadQuestionsForContest(contestId);
    notifyListeners();
  }

  void _loadQuestionsForContest(String contestId) {
    _currentQuestions = [
      Question(
        id: '1',
  ...
  List<Contest> get trendingContests => _contests.where((contest) => contest.isTrending).toList();
